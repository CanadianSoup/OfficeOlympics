			...
			<ol class="property-list team">
				...
				<li class="fieldcontain">
					<span id="members-label" class="property-label"><g:message code="team.members.label" default="Members" /></span>
						...
						<span class="property-value" aria-labelledby="members-label"><g:link controller="teamMembers" action="show" id="${m.id}">${m?.playerName.encodeAsHTML()}</g:link></span>
						</g:each>
					
				</li>
				</g:if>
			
				<g:if test="${teamInstance?.score}">
				<li class="fieldcontain">
					<span id="score-label" class="property-label"><g:message code="team.score.label" default="Score" /></span>
					
						<span class="property-value" aria-labelledby="score-label"><g:fieldValue bean="${teamInstance}" field="score"/></span>
